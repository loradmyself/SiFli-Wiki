...
| 负载电容     | 7pF/11.5pF                | 芯片寄存器只可以修改7pF和11.5pF    |
...
| 参数            | 要求                      | 说明                      |
| :-------------- | :------------------------ | :------------------------ |
| 电感值          | 4.72.2μH（典型值）       | 需与芯片手册推荐值一致    |
| 饱和电流        | ≥450mA                   | 需满足峰值负载电流需求    |
| 直流电阻（DCR） | ≤0.4ohm                  | 过高会导致效率降低、发热  |
...
| :------------- | :---------------- | :-------------- | :--------------------------------------- | :----------------------------------------------------------- |
| 全系列通用     | BUCK_LX / BUCK_FB | 0V              | 约 1.25V                                 | 片内 DC-DC 输出/反馈，全系列均有                             |
...
| 常规供电版本   | AVDD33            | 0V              | 约 3.3V                                  | 3.3V 模拟电源输入（B/E/J）                                   |
| 全系列通用     | AVDD33_AUD        | 0V              | 约 3.3V                                  | 3.3V 音频电源输入                                            |
...
| 锂电池供电版本 | VCC               | 约电池电压      | 3.2V ~ 4.7V(首次上电建议3.8V以上）       | 系统主电源（0/3/5/7）                                        |
...
| 常规供电版本   | PVDD              | 0V              | 2.97V ~ 3.63V                            | 系统主电源输入（B/E/J），52D 为 1.71V ~ 1.98V                |
