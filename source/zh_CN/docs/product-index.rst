...
.. tip::
   ...
   不确定适合的芯片型号？可使用 `芯片选型对比工具 <../_static/芯片选型对比.html>`__，按需求筛选并比较产品规格。

.. rst-class:: product-index
...
.. grid:: 1 1 2 2
   :gutter: 2
   :class-container: product-series-container

   .. grid-item-card:: 硬件文档
      :class-card: hardware-docs
      ...
      * SF32LB52-DevKit-LCD（`使用指南 <https://wiki.sifli.com/board/sf32lb52x/SF32LB52-DevKit-LCD.html>`__）
      * SF32LB52-ULP(黄山派) （`使用指南 <https://wiki.lckfb.com/zh-hans/hspi-sf32lb52/lckfb-hspi-sf32lb52>`__）
      * 屏幕转接板 （`设计指南 <https://wiki.sifli.com/board/sf32lb52x/SF32LB52-DevKit-LCD-Adapter.html>`__）
   ...
   .. grid-item-card:: 软件文档
      ...
      * SDK文档（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb52x/index.html>`__）
      * API参考（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb52x/api/index.html>`__）
...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: 硬件文档
      ...
      * SF32LB52-DevKit-Nano (`使用指南 <https://wiki.sifli.com/board/sf32lb52x/SF32LB52-DevKit-Nano.html>`__ | `设计文件 <https://oshwhub.com/sifli/sf32lb52-devkit-nano>`__）
...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: 软件文档
      ...
      * SDK文档（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb58x/index.html>`__）
      * API参考（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb58x/api/index.html>`__）
...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: 软件文档
      ...
      * SDK文档（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb56x/index.html>`__）
      * API参考（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb56x/api/index.html>`__）
...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: 软件文档
      ...
      * SDK文档（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb55x/index.html>`__）
      * API参考（`查看 <https://docs.sifli.com/projects/sdk/latest/sf32lb55x/api/index.html>`__）
...
.. grid:: 1 1 2 3
   :gutter: 2
   :class-container: support-container

   .. grid-item-card:: :octicon:`package` 零售样品
      :link: https://sifli.taobao.com/
      :link-type: url

      小批量采购可直接在淘宝店铺购买样品和开发板

   .. grid-item-card:: :octicon:`mail` 批量采购
      :link: mailto:sales@sifli.com
      :link-type: url

      批量客户请发邮件至 sales@sifli.com 获取销售联系方式

   .. grid-item-card:: :octicon:`people` 开源社区
      :link: https://qm.qq.com/q/defmVpCAAU
      :link-type: url

      参与开源项目可免费申请样品，QQ群：674699679
